...
@section('content')
    @php
        $selectedParent = (old('parent_id') == null) ? null : old('parent_id');
        $selectedDP = (old('page_id') == null) ? null : old('page_id');
    @endphp
    <div class="card">
        <div class="card-header">{{ __('Add') }}</div>

        <div class="card-body p-3">
            <form action="{{ route("site.menu.save") }}" method="POST" id="pageCreateForm"  name="page_create" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-6 mb-2">
                        <div class="row">
                            <label for="pageInput" class="col-md-4 col-form-label col-form-label-sm">Page</label>
                            <div class="col-md-8">
