...
@section('content')
    ...
    @php
        $selectedType = (old("type") == null) ? $dynamicPageSection->type : old("type") ;
        $selectedModule = (old("module") == null) ? $dynamicPageSection->module : old("module") ;
    @endphp
    ...
    <div class="card">
        ...
        <div class="card-body p-3">
            <form action="{{ route("dynamic.page.section.update",["id" => $dynamicPage->id,"sid"=>$dynamicPageSection->id ]) }}" method="POST" id="pageCreateForm"  name="page_create" enctype="multipart/form-data">
                @csrf
                @method("PATCH")
                ...
                <div class="row mb-2">
                    <div class="col-md-6 mb-2">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="name_en" class="form-control form-control-sm @error("name_en") is-invalid @enderror" placeholder="Ex: Perfect HRM" value="{{ ( old("name_en") == null ) ? $dynamicPageSection->name_en : old("name_en"); }}"  required>
                    ...
                    <div class="col-md-6 mb-2">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="name_bn" class="form-control form-control-sm @error("name_bn") is-invalid @enderror" placeholder="Ex: Perfect HRM" value="{{ ( old("name_en") == null ) ? $dynamicPageSection->name_bn : old("name_en"); }}"  required>
                            ...
                            <div class="col-md-8">
                                <select name="module" class="form-control form-control-sm @error("module") is-invalid @enderror">
                                    ...
                                    @foreach ($moduleList as $moduleIndex =>$module)
                                        <option value="{{ $moduleIndex }}" {{ ($selectedModule == $moduleIndex) ? "selected" :  null }}>{{ $module }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                ...
                <div class="row mb-2" id="divText" @if($selectedType == "Module") style="display:none;"  @endif>
                    <div class="col-md-6 mb-2">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <textarea name="text_en" class="form-control form-control-sm tinymce-text-area @error("text_en") is-invalid @enderror" id="textEnInput" placeholder="Ex: Enter text">{{ ( old("text_en") == null ) ? $dynamicPageSection->text_en : old("text_en"); }}</textarea>
                                @error('text_en')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="col-md-6 mb-2">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <textarea name="text_bn" class="form-control form-control-sm tinymce-text-area @error("text_bn") is-invalid @enderror" id="textBnInput" placeholder="Ex: Enter text">{{ ( old("text_bn") == null ) ? $dynamicPageSection->text_bn : old("text_bn"); }}</textarea>
                                @error('text_bn')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
