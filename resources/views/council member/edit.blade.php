@php
    $nameEn = (old('name_en') == null) ? $councilMember->name_en : old('name_en');
    $nameBn = (old('name_bn') == null) ? $councilMember->name_bn : old('name_bn');
    $memberPositionBn = (old('member_position_bn') == null) ? $councilMember->member_position_bn : old('member_position_bn');
    $memberPositionEn = (old('member_position') == null) ? $councilMember->member_position : old('member_position');

    $council = old("council");
    $branch = old("branch");
    $membershipType = old("membership_type");

    $shortDescriptionEn = (old('short_description_en') == null) ? $councilMember->short_description_en : old('short_description_en');
    $shortDescriptionBn = (old('short_description_bn') == null) ? $councilMember->short_description_bn : old('short_description_bn');

    $descriptionEn = (old('description_en') == null) ? $councilMember->description_en : old('description_en');
    $descriptionBn = (old('description_bn') == null) ? $councilMember->description_bn : old('description_bn');

    $memberPosition = (old('member_position') == null) ? $councilMember->member_position: old('member_position');

    if($council == null){
        $council = $councilMember->council;
    }

    if($membershipType == null){
            $membershipType = $councilMember->membership_type;
    }

    if( $branch == null){
        $branch = $councilMember->branch;
    }
...
@section('content')
    <div class="card">
        ...
        <div class="card-body p-3">
            <form action="{{ route("council.member.update",["id" => $councilMember->id]) }}" method="POST"  name="council_member_edit" enctype="multipart/form-data">
                @csrf
                @method("PATCH")
                    ...
                    <div class="col-md-12 mb-2">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="membership_type" id="membershipTypeRadio2" value="Honorable advisory council" @if($membershipType == "Honorable advisory council") checked @endif>
                                        <label class="form-check-label" for="membershipTypeRadio2">Honorable advisory council</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="membership_type" id="membershipTypeRadio3" value="Attendant association council" @if($membershipType == "Attendant association council") checked @endif>
                ...
                <div class="row mb-2">
                    <div class="col-md-6 mb-2">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="member_position" class="form-control form-control-sm @error("member_position") is-invalid @enderror" id="memberPositionEnInput" placeholder="Ex: Perfect HRM" value="{{ $memberPositionEn }}">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="member_position_bn" class="form-control form-control-sm @error("member_position_bn") is-invalid @enderror" id="memberPositionBnInput" placeholder="Ex: Perfect HRM" value="{{ $memberPositionBn }}">
                ...
                <div class="row mb-2">
                    <div class="col-md-6 mb-2">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control form-control-sm short-description" name="short_description_en" id="shortDescriptionEnInput" >{{ $shortDescriptionEn }}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control form-control-sm short-description" name="short_description_bn" id="shortDescriptionBnInput" >{{ $shortDescriptionBn }}</textarea>
                ...
                <div class="row mb-2">
                    <div class="col-md-6 mb-2">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control form-control-sm full-description" name="description_en" id="descriptionEnInput">{{ $descriptionEn }}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control form-control-sm full-description" name="description_bn" id="descriptionBnInput">{{ $descriptionBn }}</textarea>
