...
@section('content')
    <div class="card">
        ...
        <div class="card-body p-3">
            <form action="{{ route("staff.member.save") }}" method="POST"  name="council_member_create" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-2">
                    <div class="col-md-6 mb-2">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control form-control-sm short-text" name="short_text_en" id="shortTextEnInput" ></textarea>
                                @error('short_text_en')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control form-control-sm short-text" name="short_text_bn" id="shortTextBnInput" ></textarea>
                                @error('short_text_bn')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
