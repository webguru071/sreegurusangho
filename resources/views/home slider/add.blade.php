...
@section('navBreadCrumb')
    <nav aria-label="breadcrumb" class="ms-3">
        <ol class="breadcrumb m-1 mb-2">
            <li class="breadcrumb-item" aria-current="page"><a href="{{ route("home.slider.index") }}">Home slider</a></li>
...
@section('content')
    <div class="card">
        ...
        <div class="card-body p-3">
            <form action="{{ route("home.slider.save") }}" method="POST"  name="home_slider_create" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-2">
                    <div class="col-md-6 mb-2">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="alt_text" class="form-control form-control-sm @error("alt_text") is-invalid @enderror" id="altTextInput" placeholder="Ex: Perfect HRM" value="{{ old("alt_text") }}"  required>
